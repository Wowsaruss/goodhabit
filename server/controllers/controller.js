module.exports = {
    ...
    submitProfileData: (req, res) => {
        const db = app.get('db')
        req.app.get('db').create_profile([req.user.id, req.body.username, req.body.addiction_type, req.body.addiction_date, req.body.first_name, req.body.last_name, req.body.sex, req.body.birthday, req.body.phone_number, req.body.profile_pic, req.body.about_me]).then(profile => {
            res.send()
        })
        .catch( function(err){
            console.log(err)
